...
int main()
{
    ...
    for (D = Dmin; D <= Dmax; D = D + D_step)
    {
...

        {
            ...
            //enclose these in individual threads, associating each file pointer with a thread for initialisation
            ...
            // join all the threads produced so far and destroy thread handles
/*____________________________________________________________________________________________________________________________*/
            ...
            // Enclose the file writing code into 5 threads, controlled by semaphores (mapping of threads and semaphores is 1:1)

            // sem_t semaphore[N][N];

            // for(i = 0; i<N; i++)
            //   for(j = 0; j<N; j++)
            //       sem_init(semaphore[i][j],0,intial_value);

            for (i = 0; i < N; i++)
            {
              // use semaphores here, refer to ~/Downloads/temp/test.c
                for (j = 0; j < N; j++)
                {
...
/*______________________________________________________________________________________________________________________________________*/
            ...
            // Use threads to club this section with the previous on
            // Here, to get the rewiring probability faster, divide the array operations into multiple threads
            ...
            // Destroy the threads previously created
